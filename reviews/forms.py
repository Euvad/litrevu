...
class TicketReviewForm(forms.Form):
    ...
    ticket_description = forms.CharField(widget=forms.Textarea, label='Ticket Description', required=False)
    ...
    review_body = forms.CharField(widget=forms.Textarea, label='Review Body', required=False)
