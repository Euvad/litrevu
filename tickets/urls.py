...
from .views import CreateTicketView, EditTicketView, DeleteTicketView,CreateTicketReviewView
...
urlpatterns = [
    ...
    path('create_ticket_review/', CreateTicketReviewView.as_view(), name='create_ticket_review')
]
